...
//                 Manage NGO verification requests and approvals.
//               </p>
//             </div>
...
//       {/* SEARCH */}
//       <div className="mx-auto max-w-7xl px-6 py-8">
//         <div className="mb-8 flex items-center gap-3 rounded-2xl border bg-white px-5 py-4 shadow-sm">
...
//                       <div
//                         className={`flex items-center gap-2 rounded-full border px-3 py-1 text-sm font-semibold ${getStatusColor(
//                           ngo.status
//                         )}`}
//                       >
