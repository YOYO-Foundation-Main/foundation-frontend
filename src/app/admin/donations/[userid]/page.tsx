...
//   useEffect(() => {
//     if (numericUserId) fetchDonorData();
//   }, [numericUserId]);
...
//                         {d.type === "PRODUCT" ? "View Items" : "View Details"}
//                       </span>
//                     </td>
...
//                   {expandedId === d.id && d.type === "PRODUCT" && (
//                     <tr>
...
//                                 This donation was made as money, not products.
//                               </p>
//                             </div>
