  ...
  return (
    <div className="bg-[#F7F7F7] min-h-screen py-10">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10">
        ...
        {/* ================= RIGHT SIDE ================= */}
        <div className="bg-white rounded-2xl shadow-lg p-6 mt-24 lg:mt-0 h-fit sticky top-24">
...
{/* 
                      ...
                      {qty === 0 ? (
                        <button
                          ...
                          className="w-full border border-[#FF4D2D] text-[#FF4D2D] py-1.5 rounded-lg text-sm font-semibold hover:bg-[#FF4D2D] hover:text-white transition"
                        >
                          Add
                        </button>
                      ) : (
                        <div className="flex items-center justify-between bg-[#FF4D2D] text-white rounded-lg px-2 py-1">
              ...
              <div className="mt-8 border-t pt-4">
                ...
                <button className="w-full bg-[#FF4D2D] text-white py-3 rounded-xl font-bold text-lg hover:opacity-90 transition">
                  DONATE NOW (₹{Object.entries(selectedProducts).reduce((sum, [id, qty]) => {
          ...
          {mode === "money" && (
            <div>
              ...
              <div className="border-t pt-4">
                ...
                <button className="w-full bg-[#FF4D2D] text-white py-3 rounded-xl font-semibold text-sm hover:opacity-90 transition">
